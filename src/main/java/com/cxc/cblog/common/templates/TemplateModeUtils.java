 ...
 */
public class TemplateModeUtils {
    ...
    public static String convertString(TemplateModel model)throws TemplateException {
        if (model != null) {
    ...
    public static String[] convertStringArray(TemplateModel model)throws TemplateException {
        if (model != null) {
    ...
    public static Integer convertInteger(TemplateModel model)throws TemplateException {
        if (model != null) {
    ...
    public static Short convertShort(TemplateModel model)throws TemplateException {
        if (model != null) {
            if (model instanceof TemplateNumberModel) {
    ...
    public static Long convertLong(TemplateModel model)throws TemplateException {
        if (model != null) {
            if (model instanceof TemplateNumberModel) {
    ...
    public static Double convertDouble(TemplateModel model)throws TemplateException {
        if (model != null) {
            if (model instanceof TemplateNumberModel) {
    ...
    public static Date parseDate(String date) {
        ...
        try {
            if (FULL_DATE_LENGTH == date.length()) {
                res = FULL_DATE_FORMAT.parse(date);
            } else if (SHORT_DATE_LENGTH == date.length()) {
                res = SHORT_DATE_FORMAT.parse(date);
            }
